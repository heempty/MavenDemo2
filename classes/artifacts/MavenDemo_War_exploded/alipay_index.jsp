...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="alipay/pay.do" method=post
			target="_blank">
		...
		<form name=tradequery action=alipay/query.do method=post
			target="_blank">
		...
		<form name=traderefund action=alipay/refund.do method=post
			target="_blank">
		...
		<form name=traderefundquery
			action= alipay/refund_query.do method=post
			target="_blank">
		...
		<form name=tradeclose action=alipay/close.do method=post
			target="_blank">
